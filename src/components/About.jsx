...
const values = [
  { icon: <Heart size={18} className="text-[#00C9A7]" />, title: 'Compassionate Care', desc: 'Every patient treated with dignity and empathy' },
  { icon: <Shield size={18} className="text-[#E8A838]" />, title: 'Advanced Technology', desc: 'State-of-the-art equipment & modern ICU' },
  { icon: <Star size={18} className="text-[#00C9A7]" />, title: 'Expert Specialists', desc: 'Highly qualified doctors across all fields' },
]
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <div className="relative rounded-3xl overflow-hidden h-[480px] bg-gradient-to-br from-[#0F2040] to-[#0A1628] border border-white/5">
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="text-center">
                  ...
                  <img src="./karishmaa-hospital-front.webp" alt="Hospital Front" />
                </div>
              </div>
              {/* Gradient overlay */}
            ...
            <motion.div
              ...
              style={{ background: 'rgba(10,22,40,0.9)', border: '1px solid rgba(0,201,167,0.15)' }}
            >
              <div className="flex items-center gap-3 mb-3">
                ...
                <div>
                  <p className="text-white text-sm font-semibold">Master Majeed</p>
                  <p className="text-[#00C9A7] text-xs">Founder & Director</p>
                </div>
              </div>
              <p className="text-white/50 text-xs leading-relaxed italic">
                "Health is the greatest gift — we protect it with all our heart."
              </p>
            </motion.div>
            ...
            >
              <p className="text-white font-display font-bold text-xl leading-none">10+</p>
              <p className="text-white/80 text-[9px] font-semibold uppercase tracking-wider">Years</p>
            </motion.div>
          </motion.div>
          ...
          >
            ...
            <p className="text-white/60 leading-relaxed mb-6">
              Located at 22, Surya Nagar, Khudanpuri, Alwar — Karishmaa Multi-Speciality Hospital was founded 
              with a simple but powerful mission: to bring comprehensive, high-quality healthcare to every 
              family in the Alwar region.
            </p>
            <p className="text-white/60 leading-relaxed mb-8">
              Under the visionary leadership of <span className="text-white font-semibold">Master Majeed</span>, we have grown 
              into a trusted medical institution offering advanced diagnostics, a fully-equipped ICU, 
              critical care, and a dedicated in-house pharmacy — all under one roof.
            </p>
            ...
            <div className="grid grid-cols-2 gap-3">
              {[
                ...
                <div key={item} className="flex items-center gap-2">
                  <CheckCircle2 size={14} className="text-[#00C9A7] flex-shrink-0" />
